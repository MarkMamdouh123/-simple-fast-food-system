...
public: //initialization
    ...
    void delivery() { //function delivery
        ...
        } else if (delivery_user == "delivery") {
...
public:
    Sandwiches(){};
    friend void set_all(Meals m[10], Sandwiches s[10], Drinks_Desserts d[10]);
    Sandwiches(string n, double p, int o) : Menu(n, p, o) {}
    void display_sandwich() {
        cout << "======================================================================" << endl;
...
class Drinks_Desserts : public Menu {
public:
    Drinks_Desserts(){};
    friend void set_all(Meals m[10], Sandwiches s[10], Drinks_Desserts d[10]);
    Drinks_Desserts(string n, double p, int o) : Menu(n, p, o) {}
    void display_drinks_desserts() {
        cout << "=======================================================================" << endl;
    ...
    void pick(Drinks_Desserts d[10]) { //pick drink
        cout << "Please choose a number of the order you want from the Menu from 1 to 10" << endl;
        int number;
        int quantity;
        fstream receipt;
...
void set_all(Meals m[10], Sandwiches s[10], Drinks_Desserts d[10]) {//to set all fo the objects and send them to all of the classes
...
void pick(Meals m, Sandwiches s, Drinks_Desserts d, Meals me[10], Sandwiches sa[10], Drinks_Desserts dr[10]) {
    ...
    do {
        ...
        if (pick == 1) {
            s.display_sandwich(); // display MENU
...
void receipt(){
    ...
    cout <<"The date and time :"<< ctime(&givemetime) ;
    cout<<"=========================================================\n";
    cout<<"\tyour order is : \n";
    ...
    cout<<"\tthe tax amount is : $"<<tax(price())<<endl;//take a double from the function double
    cout<<"\ttotal price after adding 14% tax is: $"<<adding_tax(price())<<endl;//take a double from the function double
    cout<<"=========================================================\n";
